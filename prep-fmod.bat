...
cp fmodapi375win/api/fmod.dll		indra/BUILD-VC90/newview/RelWithDebInfo/
cp fmodapi375win/api/fmod.dll		indra/BUILD-VC90/newview/Release/
cp fmodapi375win/api/fmod.dll		indra/BUILD-VC90/newview/Debug/
