...
bool LLGLManager::initGL()
{
	...
	LL_INFOS("RenderInit") << "LL fucked up their gl version check code, skipping version grab. (llgl.cpp:362)" << LL_ENDL;
...
*/
	...
	S32 len = (S32)version.length();	/* Flawfinder: ignore */
	S32 i = 0;
	S32 start;
