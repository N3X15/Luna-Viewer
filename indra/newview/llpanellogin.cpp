...
#endif
	if(gLuaHooks) gLuaHooks->callLuaHook("OnLoginPanelLoaded",0);
...
void LLPanelLogin::loadLoginPage()
{
	...
	/**
			* ShoopedLife Splash Screen version auto-append
			*
...
#endif
			login_splash.append(llformat("%d/%d/%d/%d",SHL_VERSION_MAJOR,SHL_VERSION_MINOR,SHL_VERSION_PATCH,SHL_VERSION_BUILD));
