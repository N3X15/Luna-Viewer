...
:	LLFloater( std::string("Release Message Floater") )
...
bool LLFloaterReleaseMsg::checkVersion(const std::string& version_channel)
{
	bool res = false;
...
void LLFloaterReleaseMsg::displayMessage(const std::string& version_channel)
{
