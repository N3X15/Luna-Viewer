...
echo "	XCOPY	Lua5.1.dll"
xcopy ..\..\libraries\i686-win32\lib_release\Lua5.1.dll		.\ReleaseForDownload\ /y /q

echo "	XCOPY	lfs.dll"
xcopy ..\..\libraries\i686-win32\lib_release\lfs.dll		.\ReleaseForDownload\ /y /q
...
echo "	XCOPY	freebl3.dll"
xcopy ..\..\libraries\i686-win32\lib_release\freebl3.dll			.\ReleaseForDownload\ /y /q

echo "	XCOPY	gksvggdiplus.dll"
xcopy ..\..\libraries\i686-win32\lib_release\gksvggdiplus.dll			.\ReleaseForDownload\ /y /q

echo "	XCOPY	js3250.dll"
xcopy ..\..\libraries\i686-win32\lib_release\js3250.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	nspr4.dll"
xcopy ..\..\libraries\i686-win32\lib_release\nspr4.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	nss3.dll"
xcopy ..\..\libraries\i686-win32\lib_release\nss3.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	nssckbi.dll"
xcopy ..\..\libraries\i686-win32\lib_release\nssckbi.dll			.\ReleaseForDownload\ /y /q

echo "	XCOPY	plc4.dll"
xcopy ..\..\libraries\i686-win32\lib_release\plc4.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	plds4.dll"
xcopy ..\..\libraries\i686-win32\lib_release\plds4.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	smime3.dll"
xcopy ..\..\libraries\i686-win32\lib_release\smime3.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	softokn3.dll"
xcopy ..\..\libraries\i686-win32\lib_release\softokn3.dll			.\ReleaseForDownload\ /y /q

echo "	XCOPY	ssl3.dll"
xcopy ..\..\libraries\i686-win32\lib_release\ssl3.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	xpcom.dll"
xcopy ..\..\libraries\i686-win32\lib_release\xpcom.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	xul.dll"
xcopy ..\..\libraries\i686-win32\lib_release\xul.dll				.\ReleaseForDownload\ /y /q

echo "	XCOPY	openjpeg.dll"
xcopy ..\..\libraries\i686-win32\lib_release\openjpeg.dll			.\ReleaseForDownload\ /y /q
