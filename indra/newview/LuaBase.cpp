...
#define SWIGTYPE_p_LLFloater swig_types[6]
#define SWIGTYPE_p_LLMultiFloater swig_types[7]
#define SWIGTYPE_p_LLPanel swig_types[8]
#define SWIGTYPE_p_LLPartSysData swig_types[9]
#define SWIGTYPE_p_LLPrimitive swig_types[10]
#define SWIGTYPE_p_LLSafeHandleT_LLObjectSelection_t swig_types[11]
#define SWIGTYPE_p_LLSelectMgr swig_types[12]
#define SWIGTYPE_p_LLStaticViewerObject swig_types[13]
#define SWIGTYPE_p_LLUUID swig_types[14]
#define SWIGTYPE_p_LLVOAvatar swig_types[15]
#define SWIGTYPE_p_LLVOVolume swig_types[16]
#define SWIGTYPE_p_LLVector2 swig_types[17]
#define SWIGTYPE_p_LLVector3 swig_types[18]
#define SWIGTYPE_p_LLVector4 swig_types[19]
#define SWIGTYPE_p_LLViewerInventoryItem swig_types[20]
#define SWIGTYPE_p_LLViewerObject swig_types[21]
#define SWIGTYPE_p_LLViewerRegion swig_types[22]
#define SWIGTYPE_p_LLWearable swig_types[23]
#define SWIGTYPE_p_LuaAgent swig_types[24]
#define SWIGTYPE_p_LuaButton swig_types[25]
#define SWIGTYPE_p_LuaFloater swig_types[26]
#define SWIGTYPE_p_LuaLineEditor swig_types[27]
#define SWIGTYPE_p_LuaObject swig_types[28]
#define SWIGTYPE_p_LuaObjectManager swig_types[29]
#define SWIGTYPE_p_LuaPanel swig_types[30]
#define SWIGTYPE_p_LuaSelectionManager swig_types[31]
#define SWIGTYPE_p_LuaTextBox swig_types[32]
#define SWIGTYPE_p_LuaUICtrl swig_types[33]
#define SWIGTYPE_p_LuaUIManager swig_types[34]
#define SWIGTYPE_p_ParticleSystem swig_types[35]
...
static int _wrap_setParamOnSelf(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("setParamOnSelf",1,"std::string const &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("setParamOnSelf",2,"double");
  temp1.assign(lua_tostring(L,1),lua_strlen(L,1)); arg1=&temp1;
  arg2 = (double)lua_tonumber(L, 2);
  setParamOnSelf((std::string const &)*arg1,arg2);
...
static int _wrap_setParamOnTarget(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("setParamOnTarget",2,"std::string const &");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("setParamOnTarget",3,"double");
  SWIG_contract_assert(temp1.set(lua_tostring(L,1),false),"Must be of UUID format.")
  arg1=&temp1;
  temp2.assign(lua_tostring(L,2),lua_strlen(L,2)); arg2=&temp2;
  arg3 = (double)lua_tonumber(L, 3);
  setParamOnTarget((LLUUID const &)*arg1,(std::string const &)*arg2,arg3);
...
static swig_type_info _swigt__p_LLVector3 = {"_p_LLVector3", "LLVector3 *|LLSimLocalVec *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_LLVector4 = {"_p_LLVector4", "LLVector4 *", 0, 0, (void*)0, 0};
